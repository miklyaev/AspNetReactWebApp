...
- Строка 149: `"я не блядь в процентах"` в CSS-классе
- Строка 155: `"Я знаю"` внутри div

**Решение**: немедленно удалить мусорный текст.

### 1.4 Неиспользуемые Password-поля в сущностях
